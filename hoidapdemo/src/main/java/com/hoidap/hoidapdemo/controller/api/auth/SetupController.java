...
// public SetupController(AdminJpaRepository adminRepo, CVHTJpaRepository
// cvhtRepo,
// SinhVienJpaRepository sinhVienRepo, LopJpaRepository lopRepo, PasswordEncoder
// passwordEncoder) {
...
// public ResponseEntity<String> createAdmin(@RequestBody Map<String, String>
// body) {
...
// password.isBlank()) {
// return ResponseEntity.badRequest().body("Email va password khong duoc de
// trong!");
// }
// if (!email.endsWith("@thanglong.edu.vn")) {
// return ResponseEntity.badRequest().body("Email phai co duoi
// @thanglong.edu.vn");
// }
// if (adminRepo.findByEmail(email).isPresent()) {
// return ResponseEntity.status(409).body("Admin da ton tai voi email: " +
// email);
// }
...
// public ResponseEntity<String> createCvht(@RequestBody Map<String, String>
// body) {
// String email = body.get("email");
// String password = body.get("password");
...
// return ResponseEntity.status(409).body("CVHT da ton tai voi email: " +
// email);
// }
...
// return ResponseEntity.ok("Tao CVHT thanh cong! Ma: " + maCv + " | Email: " +
// email);
// }

// @PostMapping("/create-student")
// public ResponseEntity<String> createStudent(@RequestBody Map<String, String>
// body) {
// String email = body.get("email");
// String password = body.get("password");
...
// return ResponseEntity.status(409).body("Sinh vien da ton tai voi email: " +
// email);
// }
...
// return ResponseEntity.ok("Tao Sinh Vien thanh cong! Ma: " + maSv + " | Email:
// " + email);
// }
...
// return ResponseEntity.badRequest().body("Loi: Chua co tai khoan sinhvien hoac
// covan. Hay chay create-student va create-cvht truoc.");
// }
...
// return ResponseEntity.ok("Setup thanh cong! Sinh vien " + sv.getMaSv() + " da
// duoc gan vao lop " + maLop + " do CVHT " + cv.getMaCv() + " quan ly.");
// } catch (Exception e) {
// return ResponseEntity.internalServerError().body("Loi setup: " +
// e.getMessage());
// }
// }
...
// if (sv.getLop() != null) {
// details.put("cvht", sv.getLop().getCvht() != null ?
// sv.getLop().getCvht().getMaCv() : "null");
// details.put("tenCvht", sv.getLop().getCvht() != null ?
// sv.getLop().getCvht().getHoTen() : "null");
// }
